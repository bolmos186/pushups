...
We used a t test because the categorical variable has only two levels of position line and skill. 

The p value is 9.421e-06 < 0.05, the null hypothesis is extremely unlikely; We reject the null hypothesis and accept the alternative hypothesis because there is clearly is a difference in the amount of pushups a player can do based on the line and skill. 
